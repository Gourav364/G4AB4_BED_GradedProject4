...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Override
    public List<Employee> findEmployeeByFirstName(String firstname) throws EmployeeException {
        return employeeRepository.findAllByFirstName(firstname);
    }

    @Override
    public List<Employee> findAllEmployeeByOrder(String order) throws EmployeeException {

        if("desc".equals(order))  return employeeRepository.findAllByOrderByFirstNameDesc();
